...
namespace GraphProcessor
{
    ...
    public abstract class BaseGraphWindow : EditorWindow
    {
        ...
        public event Action<GraphBase> graphLoaded;
        public event Action<GraphBase> graphUnloaded;
        ...
        public void InitializeGraph(GraphBase graph)
        {
        ...
        protected abstract void InitializeWindow(GraphBase graph);
